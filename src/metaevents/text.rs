...
const METAEVENT_BYTE_TYPE: u8 = 0x01;
...
mod text_event_tests {
    use crate::{
        events::{Event, FromBytes},
        metadata::TimeDivision,
        metaevents::{from_vlq_to_bytes, text::METAEVENT_BYTE_TYPE, METAEVENT_BYTE},
    };

    use super::TextEvent;

    #[test]
    fn create_text_struct_from_bytes_success_one_byte_vlq() {
        let test_text =
            String::from("This is some block of text. It should be used to describe something");
